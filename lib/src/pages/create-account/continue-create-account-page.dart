                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        controller.genderPerson == GenderPerson.other ?
                                          Flexible(child: Container(margin: const EdgeInsets.only(left: 20), child: Input(controller: controller.genderController, type: TextInputType.text, label: Text('gênero'), hintText: 'Insira seu gênero...')))
                                        : const SizedBox()
                                      ],
                                    ),
                                  ],
